...
public class ResolucaoProva1 {
	...
	public static void main(String[] args) {
		...
		do {
			...
			estado = JOptionPane.showInputDialog("Informe a sua UF!  EX: SC").toUpperCase();
			...
			beneficioAM = EstadoAmazonas(estado, beneficio);		
			acrescimo = acrescimo + beneficioAM;
    ...
    public static double BeneficioEmpregador2(Object escolha, double beneficio, double acrescimo, int funcionarios) {
        ...
        if (escolha.equals("Empregador") && (funcionarios <= 40)) {

            acrescimo = beneficio * 0.11;
    ...
    public static double EstadoAmazonas(String estado, double beneficio) {
